...
public class FileEnums {
    ...
    public static String M3U8_INDEX_FILE_NAME_PREX = "index-f";

    public static String FFMPEG_TS_FILE_PATH = "ffmpegTsFilePath.txt";
    ...
    public static String VIDEO_FILE_EXTENSION_NAME = ".mp4";

    public static String M3U8_FILE_EXTENSION_NAME = ".m3u8";

    public static String URL_FILE_EXTENSION_NAME = ".url";

    public static String TXT_FILE_EXTENSION_NAME = ".txt";
